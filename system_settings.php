...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Tên hệ thống</label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Số liên lạc</label>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-system_settings">Lưu</button>
